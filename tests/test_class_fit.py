...
def test_fit_returns_self_and_stores_artifacts(
    ...
    assert np.array_equal(obj.cluster_persistence_k_max, hdb_obj.cluster_persistence_)
    assert np.array_equal(obj._single_linkage_tree_k_max, hdb_obj._single_linkage_tree)
